...
class ExpenseReportTest {
    ...
    void should_print_report_for_dinner_meal_not_exceeding_limit() {
        ...
        Expense expense = new Expense(ExpenseType.DINNER, 4000);
    ...
    void should_print_report_for_dinner_meal_over_expense_and_breakfast() {
        ...
        ExpenseReport expenseReport = new ExpenseReport();
        Expense dinnerExpense = new Expense(ExpenseType.DINNER, 5001);
        Expense breakfastExpense = new Expense(ExpenseType.BREAKFAST,300);
    ...
    void should_print_report_for_dinner_meal_over_expense_and_rental_car() {
        ...
        ExpenseReport expenseReport = new ExpenseReport();
        Expense dinnerExpense = new Expense(ExpenseType.DINNER, 5001);
        Expense carRentExpense = new Expense(ExpenseType.CAR_RENTAL,300);
